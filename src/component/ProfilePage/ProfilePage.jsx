...
//     try {
//       const response = await axios.get('http://localhost:3000/api/profile/orders', {
...
//   if (!user) return <div className="profile-page-loading">Loading...</div>;
...
//                   onChange={(e) => updateUser({ ...user, address: { ...user.address, street: e.target.value } })}
//                 />
//               </div>
//               <div className="profile-page-form-group">
//                 <label>City:</label>
...
//                   onChange={(e) => updateUser({ ...user, address: { ...user.address, city: e.target.value } })}
//                 />
//               </div>
//               <div className="profile-page-form-group">
//                 <label>State:</label>
...
//                   onChange={(e) => updateUser({ ...user, address: { ...user.address, state: e.target.value } })}
//                 />
//               </div>
//               <div className="profile-page-form-group">
//                 <label>Country:</label>
...
//                   onChange={(e) => updateUser({ ...user, address: { ...user.address, country: e.target.value } })}
//                 />
//               </div>
//               <button type="submit" className="profile-page-button">Save</button>
//             </form>
//           ) : (
...
//               <button onClick={() => setIsEditing(true)} className="profile-page-button">Edit</button>
//             </div>
//           )}
//         </div>
//       )}
...
//           {orders.length > 0 ? (
//             orders.map((order) => (
//               <div key={order._id} className="profile-page-order">
...
//           ) : (
//             <div className="profile-page-details">
//               <img src={user.avatar || "/images/Avatar.png"} alt="Avatar" className="profile-page-avatar" />
//               <p><strong>Name:</strong> {user.firstName} {user.lastName}</p>
//               <p><strong>Email:</strong> {user.email}</p>
//               <p><strong>Address:</strong> {user.address.street}, {user.address.city}, {user.address.state}, {user.address.country}</p>
//               <button onClick={() => setIsEditing(true)} className="profile-page-button">Edit</button>
...
//           updatedFormData.append(`address[${addressKey}]`, formData.address[addressKey] || '');
//         });
//       } else {
...
//     try {
//       const token = localStorage.getItem('token');
//       const response = await axios.put(`${API_BASE_URL}/api/user/profile`, updatedFormData, {
//         headers: {
...
//                     accept="image/*"
//                   />
//                   {previewImage && <img src={previewImage} alt="Preview" className="profile-avatar-preview" />}
//                 </div>
...
//             </div>
//           ) : (
//             <div className={`profile-page-info-details ${isEditing ? 'hide' : ''}`}>
